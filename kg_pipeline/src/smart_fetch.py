...
TOPIC_CLUSTERS: dict[str, dict] = {
    ...
    # ── Microbiome/Metabolite layer clusters ────────────────────────────────
    "microbiome_longevity": {
        "entities": ["Gut microbiota", "Gut dysbiosis", "Akkermansia muciniphila"],
        "keywords": ["centenarian microbiome", "gut microbiota aging", "microbiota longevity",
                     "dysbiosis aging", "microbiome diversity aging",
                     "inflammaging gut", "Akkermansia longevity",
                     "Faecalibacterium aging", "gut-brain axis aging",
                     "microbiome healthy aging"],
        "mesh": ["Gastrointestinal Microbiome", "Aging", "Longevity"],
    },
    "scfa_metabolites": {
        "entities": ["Butyrate", "Short-chain fatty acids", "Propionate"],
        "keywords": ["butyrate gut health", "short-chain fatty acids disease",
                     "SCFA inflammation", "propionate gut health",
                     "fiber fermentation SCFA", "butyrate colon cancer",
                     "butyrate inflammatory bowel", "butyrate aging",
                     "acetate gut metabolite"],
        "mesh": ["Fatty Acids, Volatile", "Butyrates", "Propionates"],
    },
    "polyphenol_metabolites": {
        "entities": ["Urolithin A", "Equol", "Postbiotic"],
        "keywords": ["urolithin A health", "equol gut microbiome",
                     "postbiotic gut health", "polyphenol gut metabolite",
                     "ellagitannin urolithin", "pomegranate gut bacteria",
                     "isoflavone equol aging", "urolithin aging muscle",
                     "polyphenol biotransformation gut"],
        "mesh": ["Polyphenols", "Phytochemicals", "Biological Transformation"],
    },
    "gut_barrier_aging": {
        "entities": ["Gut dysbiosis", "Intestinal permeability"],
        "keywords": ["intestinal permeability aging", "leaky gut aging",
                     "tight junction diet", "gut barrier nutrition",
                     "gut epithelial barrier food", "zonulin diet",
                     "gut barrier inflammaging", "mucus layer microbiome diet"],
        "mesh": ["Intestinal Mucosa", "Permeability", "Tight Junctions"],
    },
    "bile_acid_metabolites": {
        "entities": ["Secondary bile acids", "Deoxycholic acid"],
        "keywords": ["secondary bile acid gut bacteria", "gut microbiome bile acid",
                     "bile acid FXR signaling diet", "TGR5 bile food",
                     "bile acid dysbiosis disease", "bile acid microbiome aging",
                     "bile metabolism nutrition gut"],
        "mesh": ["Bile Acids and Salts", "Gastrointestinal Microbiome"],
    },
    "fermented_food_microbiome": {
        "entities": ["Lactobacillus", "Bifidobacterium", "Kefir", "Yogurt"],
        "keywords": ["fermented food microbiome", "kefir gut bacteria health",
                     "kimchi gut microbiota", "yogurt Lactobacillus aging",
                     "sauerkraut gut health", "inulin Bifidobacterium",
                     "resistant starch microbiota", "prebiotic fiber microbiome",
                     "fermented food longevity"],
        "mesh": ["Fermented Foods", "Probiotics", "Prebiotics", "Gastrointestinal Microbiome"],
    },
